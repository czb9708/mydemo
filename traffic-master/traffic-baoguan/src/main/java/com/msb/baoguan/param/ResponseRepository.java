package com.msb.baoguan.param;

import com.msb.baoguan.code.UntiCode;
...
public class ResponseRepository {
     ...
     * @return
     */
    public static ResponseResult getSuccessResult(List<TrafficUntiEntity> list){
        ResponseResult responseResult = new ResponseResult();
        UntiCode untiCode = new UntiCode();
        responseResult.setCode(untiCode.getUNTI_QUERY_SUCCESS());
        responseResult.setMsg(untiCode.getUNTI_QUERY_SUCCESS_MSG());
        responseResult.setT(list);
        return responseResult;
    }
    /**
     * 统一失败返回结果，包括失败原因
